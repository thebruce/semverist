...
describe('Extract Semverish Parts from semverish.', () => {
  ...
  test('extractSemverAlpha', () => {
    ...
    return semverah
      .then(semverishSuper =>
        semverishSuper.extractSemverishFromPath('4.1.0-alpha')
      )
  ...
  test('extractSemverAlphaDotVersion', () => {
    ...
    return semverah
      .then(semverishSuper =>
        semverishSuper.extractSemverishFromPath('4.1.0-alpha.1')
      )
  ...
  test('extractSemverDeathStar', () => {
    ...
    return semverah
      .then(semverishSuper =>
        semverishSuper.extractSemverishFromPath('4.1.0-deathstar.1')
      )
  ...
  test('extractWithAttribute', () => {
    ...
    return semverah
      .then(semverishSuper =>
        semverishSuper.extractSemverishFromPath('4.1.0.entity')
      )
      .then(obj => expect(obj).toEqual('4.1.0'));
  });
  ...
  test('extractParitalWithAttribute', () => {
    ...
    return semverah
      .then(semverishSuper =>
        semverishSuper.extractSemverishFromPath('4.1.entity')
      )
      .then(obj => expect(obj).toEqual('4.1'));
  });
  ...
  test('extractMoreParitalWithAttribute', () => {
    ...
    return semverah
      .then(semverishSuper =>
        semverishSuper.extractSemverishFromPath('4.entity')
      )
  ...
  test('extractAttributeWithAlphaAndNumber', () => {
    ...
    return semverah
      .then(semverishSuper =>
        semverishSuper.extractSemverishFromPath('4.1.0-alpha.0.entity')
      )
      .then(obj => expect(obj).toEqual('4.1.0-alpha.0'));
  });
  ...
  test('setSourceBadSourceLeading0DeepPath', () => {
    ...
    return semverah
      .then(semverishSuper => {
        semverishSuper.extractSemverishFromPath(
          '4.1.0-alpha.0entity.attribute'
        );
      })
      .catch(e => {
        expect(e.message).toEqual(
          'The semverish value must be able to be converted to a semver value. SemveristElement names can not have leading 0s.'
        );
      });
  });
