...
describe('Source Converter Super test', () => {
  ...
  test('addSemverRealizations', () => {
    ...
    return converterEx
      ...
      .then(obj => expect(obj).toEqual(['1.0.0', '1.1.0', '1.2.0']));
  });
  ...
  test('addBadSemverRealizations', () =>
    converterFactory('semverist', 'converter')
      .then(ConverterClass => {
        const converterClass = new ConverterClass();
        converterClass.init(semveristObject);
  ...
  test('Add a non existant semverist element', () => {
    ...
    return converterEx
      .then(converterClass => {
        converterClass.addConverterSemveristElement(
          'aNewElement',
          'mucky',
          '>1.1.0 <2.0.0',
          'flappy'
  ...
  test('Add a non existant semverist class item', () => {
    ...
    return converterEx
      .then(converterClass => {
        converterClass.addSemveristClassItem(
          'aNewElement',
          'newNew',
          '1.1.0',
          'semverish',
      ...
      .then(obj => Object.keys(obj).sort())
      .then(obj =>
        expect(obj).toEqual(['aNewElement', 'attribute', 'default', 'group'])
      );
  });
