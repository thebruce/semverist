  ...
  return setUp.then(extendedClass => class range extends extendedClass {
    ...
    makeInheritenceRangeFromSemverish(earlySemverish, exceptions) {
      ...
      if (_.has(this.constructor.parseSemver(tmpSemverEarly), 'release')) {
        ...
        // Otherwise, our terminal bounds has been indicated which must be smaller than the normal
        // hierarchical end (as opposed to the prerelease hierarchical end above) as indicated
        ...
        // If we've made it this far then we know that the default terminal value for this inheritence
        // is the one we want.
