  ...
  return setUp.then(extendedClass => class range extends extendedClass {
    ...
    pathToRange(pather, options) {
      ...
      if (this.useSemverImplied(options)) {
        ...
        return this.makeInheritenceRangeFromSemverish(pather, undefined, tmpExceptions);
      }
     ...
     */
    makeInheritenceRangeFromSemverish(earlySemverish, laterSemverish, exceptions) {
      let tmpExceptions;
      ...
      return this.constructor.rangeMaker(tmpSemverEarly, '>=', tmpRangeTop, '<', tmpExceptions);
    }
    ...
    makeLazySemveristRangeFromSemverish(
      ...
      if (exceptions) tmpExceptions = exceptions;
      if (laterSemverishRange) tmpSemverLater = laterSemverishRange;
