 ...
 */
module.exports = function semveristMolotov(
  configObject = { overrides: {}, cocktailClasses: [] }
) {
  return new SemveristMolotov(
    configObject.overrides,
    configObject.cocktailClasses
  );
};
