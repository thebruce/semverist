...
module.exports = function schoenberg(
  semverishSource,
  configs,
  nameSpace,
  ...
  return manifestFactory('composer', nameSpace, tmpConfig, molotovConfig)
    .then(ManifestClass =>
      Promise.all([ManifestClass.createConverter(tmpSource), ManifestClass])
    )
