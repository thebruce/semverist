...
module.exports = superclass =>
  class extends superclass {
    ...
    analyzeSemverishAdjacency(lowerSemverish, higherSemverish) {
      ...
      const levels = ['major', 'minor', 'patch', 'prerelease', 'build'];
      ...
      if (
        (differenceLevel === null &&
          semverDiff(higherSemver, lowerSemver) === null) ||
        ...
        if (
          this.semverishToArray(lowerSemverish).length === 4 &&
          ...
          this.semverishToArray(lowerSemverish).length === 5 &&
          ...
          if (
            ...
            adjacent =
              this.semverishToArray(higherSemverish)[4] -
                this.semverishToArray(lowerSemverish)[4] ===
              1;
          }
        } else if (
          this.semverishToArray(higherSemverish)[
            levels.indexOf(differenceLevel)
          ] -
            this.semverishToArray(lowerSemverish)[
              levels.indexOf(differenceLevel)
            ] ===
            1 &&
          semverDiff(semver.inc(lowerSemver, differenceLevel), higherSemver) ===
            null
        ) {
