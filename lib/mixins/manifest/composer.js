...
module.exports = superclass =>
  class extends superclass {
    /**
     * An initialization method for this class.
     * @returns {void}
     */
    init() {
    ...
    setCompositionDestination() {
      ...
      // passed to manifest.
      this.compositionDestination = _.get(
        this.getConfig(),
        'composer.destination',
        null
      );
      if (
        this.getCompositionType() === 'directory' &&
        !this.compositionDestination
      ) {
        throw new Error(
