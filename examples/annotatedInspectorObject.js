...
const inspector = {
  ...
  default: {
    // A semverist object attribute. This could represent an attribute of an object or a directory, depending on the semverist source. Defaults are good for all attributes and groups and are inherited by all.
    ...
    items: {
      // A collection of semver ranges where this semver attribute has representation.
      '^4.0.1': {
        // A semver range.
        components: [
          // an array of components that comprise this semver attributes realization for this range.
          '4.0.1.default', // This means that we have an attribute `default` in a semver hierarchy 4.0.1
        ],
      },
      '^4.0.0': {
        components: ['4.0.default'],
      },
      '^3.13': {
        components: ['3.13.default'],
      },
    },
  },
  arbitraryGroupName: {
    ...
    items: {
      '4.0.0 || ^4.02': {
        components: ['4.0.arbitraryGroupName'],
      },
      '^4.0.1': {
        components: ['4.0.1.default', '4.0.arbitraryGroupName'],
      },
      '3.13.0': {
        components: ['3.13.0.arbitaryGroupName', '3.13.default'],
      },
    },
  },
  episodes: {
    ...
    items: {
      '4.0.0 && >4.0.1': {
        components: ['4.0.arbitraryGroupName', '4.episodes'],
      },
      '4.0.1': {
        components: [
          '4.0.1.episode',
      ...
      '^3.13.0': {
        components: ['3.13.arbitraryGroupName', '3.13.default'],
      },
    },
  },
};
